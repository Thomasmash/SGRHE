                                          ...
                                          <div class="tab-pane" id="ITrimestre">
                                            <!-- Formulario I  Trimestre -->
                                                <div class="card card-primary">
                                                  ...
                                                  <div class="card-footer">
                                                      <button class="btn btn-primary w-100 m-1" data-toggle="modal" data-target="#addAproveitamentoI" >
                                                        Inserir
                                                      </button>
                                          ...
                                          <div class="tab-pane" id="IITrimestre">
                                              <!-- Formulario II  Trimestre -->
                                                <div class="card card-primary">
                                                    ...
                                                    <table id="tabelaII" class="table table-bordered table-striped">
                                                      ...
                                                      <!--Invocando outro elementos/ Tabelas -->
                                                                    ...
                                                                    <tr class="">
                                                                        ...
                                                                        <td>
                                                                        <button class="btn btn-warning w-100 m-1" data-toggle="modal" data-target="#addAproveitamento{{ $aproveitamentoII->id }}editar" >
                                                                        Editar
                                                                        </button>
                                                  ...
                                                  <div class="card-footer">
                                                      <button class="btn btn-primary w-100 m-1" data-toggle="modal" data-target="#addAproveitamentoII" >
                                                        Inserir
                                                      </button>
                                          ...
                                          <div class="tab-pane" id="IIITrimestre">
                                              <!-- Formulario III  Trimestre -->
                                                <div class="card card-primary">
                                                  ...
                                                  <div class="card-footer">
                                                      <button class="btn btn-primary w-100 m-1" data-toggle="modal" data-target="#addAproveitamentoIII" >
                                                        Inserir
                                                      </button>
                                          ...
                                          <div class="tab-pane" id="Final">
                                              <!-- Formulario II  Trimestre -->
                                                <div class="card card-primary">
                                                  ...
                                                  <div class="card-footer">
                                                      <button class="btn btn-primary w-100 m-1" data-toggle="modal" data-target="#addAproveitamentoFinal" >
                                                        Inserir
                                                      </button>
